...
import br.com.senac.java_spring_aula.todolist.model.ListaPostDTO;
...
public class ToDoListController {
    ...
    public ResponseEntity<ListaEntity> createTask(@Valid @RequestBody ListaPostDTO dto) {
        ...
        ListaEntity salve = listaRepository.save(listaEntity);
    ...
    public ResponseEntity<ListaEntity> cancelTask(@PathVariable int id){
        ...
        listaEntity.setStatus(ListaStatus.CANCELED);
